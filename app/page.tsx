						...
						<Row className="w-100 align-items-center flex-column-reverse flex-md-row">
							...
							<Col md={6}>
								...
								<div className="d-flex justify-content-center justify-content-md-start gap-3 mb-5">
									...
									<Button href="https://drive.google.com/file/d/14g-jq2qpP4SsfITrTqSf0DaQJeBP6prL/view?usp=sharing" target="_blank" size="lg" variant="outline-light" className="scale-mobile px-5 rounded-1">
										Download CV
									</Button>
								</div>
